   ...
   finalEvents.add(Container(
     ...
     child:Column(
       ...
       children: <Widget>[
         ...
         SizedBox(height:5),
         Text("Start DateTime: ${event.startDate.toDate()}",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500, color: Colors.white)),
         Text("End DateTime: ${event.endDate.toDate()}",style: TextStyle(fontSize: 17,fontWeight: FontWeight.w500, color: Colors.white)),
